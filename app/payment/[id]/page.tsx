      ...
      if (success) {
        ...
        try {
            ...
            if (invRes.ok) {
                ...
                if (invData?.url) setGeneratedInvoiceUrl(invData.url);
            }
        } catch (e) {
        ...
        toast({
          ...
          description: "Payment recorded. Your booking is pending staff confirmation.",
        });
      }
    } catch {
      toast({
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Payment recorded for {car.make} {car.model}. Your booking is pending staff confirmation.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                {(generatedInvoiceUrl ?? booking.invoiceUrl) && (
                    <Button variant="outline" asChild>
                        <a href={generatedInvoiceUrl ?? booking.invoiceUrl} target="_blank" rel="noopener noreferrer">
                            Download Invoice
                        </a>
                    </Button>
                )}
