...
import { StaffBookingsClient } from "@/components/role-pages/bookings-client";
    ...
    <div className="container px-4 py-8">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">URL-based filtering — shareable and reload-safe.</p>
        </div>
