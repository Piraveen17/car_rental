...
${cars.map((car) => `- ${car.year} ${car.make} ${car.model}: $${car.pricePerDay}/day, ${car.seats} seats, ${car.transmission}, ${car.fuelType}, Location: ${car.location}, Features: ${car.features.join(", ")}`).join("\n")}
